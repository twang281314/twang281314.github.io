window.onload = function () {
    ...
    $('.code li').each(function () {
        ...
        var values = ['"zh-CN"', '"container"', '"title"', '"avatar"', '"logo.jpg"', '"me"', '"canvas"',
            '"http://anytao.net"', '"fa fa-home"', '"https://github.com/twang281314"', '"fa fa-github"', '"http://demo.anytao.net"', '"fa fa-th-large"'];
        for (var i in values) {
            $(this).html($(this).html().replace(values[i], '<span class="Yellow">' + values[i] + '</span>'));
        }
        //修改文本颜色
        var txt = ['About Me','I Am In HangZhou Now','Index','Github','Demo','1106217752','luckywgm@gmail.com'];
        for(var i in txt){
    ...
    var arr = [{
        ...
        ele: ".two",
        cont: '<img src="https://avatars0.githubusercontent.com/u/10482721?s=460&v=4" alt="me" class="avatar">',
        delay: 4000
    }, {
        ele: ".three",
        cont: '<h2>I Am In HangZhou Now</h2>',
        delay: 8000
    }, {
        ele: ".four",
        ...
        ele: ".nine",
        cont: '<footer>' +
        '<a href="http://anytao.net" target="_blank"><i class="fa fa-home"></i>Index</a>' +
        '<a href="https://github.com/twang281314" target="_blank"><i class="fa fa-github"></i>Github</a>' +
        '<a href="http://demo.anytao.net" target="_blank"><i class="fa fa-th-large"></i>Demo</a>' +
        '</footer>',
        delay: 30000
    }];
    for (var i in arr) {
